...
__kernel void vie_tiled (__global unsigned *in, __global unsigned *out)
{
  int x = get_global_id (0); 
  int y = get_global_id (1);
...
__kernel void vie (__global unsigned *in, __global unsigned *out, __global unsigned *changed_in, __global unsigned *changed_out)
{
  int x = get_global_id (0); 
  int y = get_global_id (1);
